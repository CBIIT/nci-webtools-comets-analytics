                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--facebook" href="https://www.facebook.com/cancer.gov">
                      <svg
                        ...
                        className="usa-icon"
                        role="img"
                        aria-labelledby="facebook-title-site">
                        <title id="facebook-title-site">Facebook</title>
                  ...
                  <div className="grid-col-auto">
                    <a
                      ...
                      <svg
                        ...
                        className="usa-icon"
                        role="img"
                        aria-labelledby="instagram-title-site">
                        <title id="instagram-title-site">Instagram</title>
                  ...
                  <div className="grid-col-auto">
                    <a className="usa-social-link usa-social-link--youtube" href="https://www.youtube.com/NCIgov">
                      <svg
                        ...
                        className="usa-icon"
                        role="img"
                        aria-labelledby="youtube-title-site">
                        <title id="youtube-title-site">Youtube</title>
                  ...
                  <div className="grid-col-auto">
                    <a
                      ...
                      <svg
                        ...
                        className="usa-icon"
                        role="img"
                        aria-labelledby="linkedin-title-site">
                        <title id="linkedin-title-site">Linkedin</title>
                        <g id="final_docsite">
                          <path d="M12,2C6.48,2,2,6.48,2,12s4.48,10,10,10s10-4.48,10-10S17.52,2,12,2z M8.912001,17.584H6.584v-7.472h2.328001V17.584z M7.744,9.104C6.992,9.104,6.4,8.488,6.4,7.76c0-0.752,0.592-1.344,1.344-1.344c0.728,0,1.343999,0.592,1.343999,1.344 C9.087999,8.488,8.472,9.104,7.744,9.104z M17.6,17.584h-2.328v-3.64c0-0.856-0.024001-1.967999-1.216001-1.967999 s-1.392,0.927999-1.392,1.912v3.696H10.36v-7.472h2.224v1.008h0.024c0.464-0.752,1.296-1.216001,2.199999-1.192 c2.352001,0,2.792,1.552001,2.792,3.544001C17.6,13.472,17.6,17.584,17.6,17.584z" />
                        </g>
                      </svg>
                    </a>
                  </div>
